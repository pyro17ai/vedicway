  ...
  return (
    <div className="admin-page">
      <aside className="admin-rail">
        <button className="admin-brand" type="button" onClick={() => onNavigate("/")}><img src="/assets/brand-mark-light.png" alt="" /><span>VedicWay<small>Управление сайтом</small></span></button>
