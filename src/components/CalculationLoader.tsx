...
const loaderCopy: Record<CalculationLoaderVariant, {
  ...
  explanation: {
    kicker: "ПЕРВОЕ ЧТЕНИЕ",
    title: "Готовим объяснение карты",
    description: "Связываем готовые положения с жизненными темами и проверяем опору каждого вывода.",
    note: "Расчёт продолжится, если открыть соседний раздел",
  },
  questions: {
    kicker: "ЛИЧНОЕ НАБЛЮДЕНИЕ",
    title: "Составляем вопросы к себе",
    description: "Превращаем факты карты в вопросы для личного наблюдения без готовых ответов.",
    note: "Вопросы появятся здесь автоматически",
  },
  rectification: {
    kicker: "РАСЧЁТ ИДЁТ",
